...
import Drum from "../assets/Drum.png";  // Assuming you have an image for the drum machine
...
const projectCardData = [
    ...
    {
        imgsrc: Drum,
        title: "Dynamic Drum Machine: Create and Play Custom Beats",
        text: "Unleash your musical creativity with the Dynamic Drum Machine. This project allows users to create and play custom drum beats using an intuitive interface. Perfect for musicians, producers, and anyone interested in rhythm and music production. Explore the features and start making music today!",
        view: "https://drummachinemiz.netlify.app/",
        source: "https://github.com/miz2/DrumMachine"
    }
];
